...
const ITEMS = [
  { title: 'Interchangeable Hooks', desc: 'Single, double, and product-specific hook profiles for maximum flexibility.',  img: '/assets/customization/hooks-crop.jpg' },
  { title: 'Adjustable Shelves',    desc: 'Tool-free repositioning across the full panel height to fit any product.',      img: '/assets/customization/shelves-crop.jpg' },
  { title: 'Pegboard Panels',       desc: 'Standard and reinforced gauges for heavy SKUs and hooks.',                      img: '/assets/customization/pegboard-crop.jpg' },
  { title: 'Branding Toppers',      desc: 'Printed, embossed, or backlit header units for strong brand presence.',         img: '/assets/customization/topper-crop.jpg' },
  { title: 'RAL Color Range',       desc: 'Any RAL powder-coated finish for perfect brand alignment.',                     img: '/assets/customization/ral-crop.jpg' },
  { title: 'Modular Accessories',   desc: 'Trays, dividers, price rails, lighting, and more to complete your display.',    img: '/assets/customization/accesories-crop.jpg' },
]
